...
class GoobiCommunicate() :
	...
	#http://goobi.bodleian.ox.ac.uk/goobi/wi?command=AddProperty&processId=105&property=testproperty&value=testvalue&token=intranda
	...
	def _send( self, command, additional=None ) :
		...
		# TODO: Tidy this up. Need to catch exceptions properly and ensure request is closed (although python handles that too)
		try:
